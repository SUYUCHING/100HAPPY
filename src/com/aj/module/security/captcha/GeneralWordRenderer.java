...
public class GeneralWordRenderer implements WordRenderer {
	...
	public GeneralWordRenderer() {
		this(DEFAULT_COLOR, DEFAULT_FONTS);

	}

	public GeneralWordRenderer(Color color, List<Font> fonts) {
	...
	public void render(String word, BufferedImage image) {
		...
		for (char element : wc) {
			...
			double charWitdth = gv.getVisualBounds().getWidth()+2;
			g.drawChars(itchar, 0, itchar.length, startPosX, 18);
